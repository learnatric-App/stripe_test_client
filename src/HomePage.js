...
function HomePage() {
  ...
  const handleSubmitSub = async (event) => {
    ...
    if (result.error) {
      ...
      const res = await axios.post('http://18.116.82.34:8081/sub', {'payment_method': result.paymentMethod.id, 'email': email, child_count: 3, plan_selected: 'Monthly', parent_id: 1});
